    ...
    cream: {
      ...
      artDecoVars: {
        dark: withLegacy({
          ...
          '--selected-bg': 'rgba(111, 139, 61, 0.22)',
          '--selected-text': '#f7f2e8',
          '--selected-border': 'rgba(145, 171, 87, 0.34)',
          ...
          '--artdeco-rotate-secondary': 'rgba(111, 139, 61, 0.08)',
          '--overlay-opacity': '0.24',
          '--grid-line-color': 'rgba(255, 244, 230, 0.05)',
          '--success-soft': 'rgba(111, 139, 61, 0.2)',
          '--success-text': '#edf7d9',
        ...
        light: withLegacy({
          ...
          '--selected-bg': 'rgba(111, 139, 61, 0.16)',
          '--selected-text': '#4b5d29',
          '--selected-border': 'rgba(111, 139, 61, 0.24)',
          ...
          '--artdeco-rotate-secondary': 'rgba(111, 139, 61, 0.04)',
          '--overlay-opacity': '0.08',
          '--grid-line-color': 'rgba(120, 96, 62, 0.05)',
          '--success-soft': 'rgba(111, 139, 61, 0.14)',
          '--success-text': '#5b7330',
